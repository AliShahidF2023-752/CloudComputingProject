...
PAGE_LOAD_TIMEOUT = float(os.getenv('PAGE_LOAD_TIMEOUT', 12))
SEARCH_WAIT = float(os.getenv('SEARCH_WAIT', 1.5))
PAGE_WAIT = float(os.getenv('PAGE_WAIT', 0.5))
MAX_PAGES_TO_VISIT = int(os.getenv('MAX_PAGES_TO_VISIT', 2))
MAX_WORKERS = int(os.getenv('MAX_WORKERS', 2))  # Number of parallel Chrome instances (adjust based on RAM)
