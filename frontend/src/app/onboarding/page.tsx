                ...
                <div className="glass-strong rounded-3xl p-8 border border-white/20 shadow-2xl">
                                ...
                                {userTypes.map((type) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`p-6 rounded-2xl border-2 transition-all duration-300 text-left card-hover ${preferences.userType === type.id
                                                    ? 'border-purple-500 glass-strong'
                            ...
                            <div className="space-y-3">
                                {educationLevels.map((level, index) => (
                                    <button
                                        ...
                                        className={`w-full p-5 rounded-xl border-2 transition-all duration-300 text-left card-hover animate-fade-in ${preferences.educationLevel === level.id
                                                ? 'border-purple-500 glass-strong'
                                                : 'border-white/10 glass hover:border-white/30'
                                            }`}
                                    >
                            ...
                            <div className="space-y-3">
                                {tones.map((tone, index) => (
                                    <button
                                        ...
                                        style={{ animationDelay: `${index * 50}ms` }}
                                        className={`w-full p-5 rounded-xl border-2 transition-all duration-300 text-left card-hover animate-fade-in ${preferences.defaultTone === tone.id
                                                ? 'border-purple-500 glass-strong'
                                                : 'border-white/10 glass hover:border-white/30'
                                            }`}
                                    >
                    ...
                    <div className="flex justify-between mt-8">
                        ...
                        <button
                            ...
                            className="ml-auto px-8 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold rounded-xl transition-all duration-300 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed btn-glow"
                        >
                            {loading ? (
                                <>
